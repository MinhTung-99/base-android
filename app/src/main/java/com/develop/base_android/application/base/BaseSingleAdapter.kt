...
import com.develop.base_android.databinding.ItemLoadingMoreBinding
...
abstract class BaseSingleAdapter<E, B : ViewBinding> :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            VIEW_TYPE_ITEM -> {
                ...
                val binding =
                    ItemLoadingMoreBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class LoadingViewHolder(itemView: ItemLoadingMoreBinding) :
